...
/*   ResourceBundle resource = ResourceBundle.getBundle("setting");
  ...
  //http 
  if("10.1.19.69,10.1.21.246".contains(serverName)){ 
		basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+"/pubcen/";
  } 
  //本地,后续考虑更改pubcen-web 
 if("localhost,10.1.58.82,10.1.58.84".contains(serverName)){ 
